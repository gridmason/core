...
Generated by the spec-to-issues run (repo `gridmason/core`). All epics are Phase A and open as `type:epic` + `status:blocked`; all sub-issues open as `status:ready`. Sub-issues are linked to their epic via GitHub sub-issues.

| Epic | Issue | Sub-issues |
|---|---|---|
| C-E0 Bootstrap | [#1](../../../../issues/1) | [#6](../../../../issues/6) Repo scaffold · [#7](../../../../issues/7) Release pipeline · [#8](../../../../issues/8) Community files |
| C-E1 Headless model | [#2](../../../../issues/2) | [#9](../../../../issues/9) Widget catalog · [#10](../../../../issues/10) Page-type registry · [#11](../../../../issues/11) LayoutDoc operations · [#12](../../../../issues/12) Engine event model |
| C-E2 Resolution + gating | [#3](../../../../issues/3) | [#13](../../../../issues/13) resolveLayout · [#14](../../../../issues/14) Copy-on-write + reset · [#15](../../../../issues/15) Picker gating · [#16](../../../../issues/16) Resolution-time gating |
| C-E3 Canvas | [#4](../../../../issues/4) | [#17](../../../../issues/17) Gridstack binding + mounting · [#18](../../../../issues/18) Edit mode · [#19](../../../../issues/19) Keyboard + a11y · [#20](../../../../issues/20) Error boundary + skeletons · [#21](../../../../issues/21) Virtualization + perf |
| C-E4 Adapters + IO | [#5](../../../../issues/5) | [#22](../../../../issues/22) Adapter interfaces + dev adapter · [#23](../../../../issues/23) Export/import + degradation · [#24](../../../../issues/24) POC importer + fixture · [#25](../../../../issues/25) Stories + e2e consolidation |

Dependency spine (epics): C-E0 → C-E1 → C-E2 → C-E3, and C-E2 → C-E4 (C-E4 runs parallel to C-E3 where possible). Cross-repo: C-E0 and C-E1 require `@gridmason/protocol@0.x` types on npm (gridmason/protocol milestone M-A).
